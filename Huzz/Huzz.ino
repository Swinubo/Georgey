...
float speedVariable = 0.5; // Adjust speed variable
int detectBallPin = 12;
bool hasBall = false;

int thresholdWhiteA0 = 510;  // Adjust this based on test readings
int thresholdWhiteA1 = 280;  // Adjust this based on test readings
...
void loop() {
    ...
    right(160 * speedVariable, 160 * speedVariable);
}
